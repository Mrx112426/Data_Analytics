...
- `Предварительный анализ данных.ipynb` — содержит предварительную очистку и анализ данных.
- `Исследовательский анализ данных.ipynb` — визуализация данных и исследование связей между признаками.
